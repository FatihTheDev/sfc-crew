  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white bg-black bg-opacity-50">
        <h1 className="text-3xl text-center font-bold mb-4 mx-2 md:mx-0">ŽELIŠ BITI DIO POZITIVNE PRIČE?</h1>
      ...
      <div className="absolute bottom-28 left-4 flex space-x-4 z-20">
        <a href="https://www.instagram.com/street.fleet.crew/" target="_blank" rel="noopener noreferrer">
          <FaInstagram className="text-white w-8 h-8 hover:text-gray-300 transition duration-300" />
        </a>
        <a href="https://www.youtube.com/@streetfleetcrew8848" target="_blank" rel="noopener noreferrer">
